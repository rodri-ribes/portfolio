...
function Portfolio() {
    ...
    const ProjectsCard = [
        { Title: "Projects-App", Technology: "ReactJS, ReduxJS, NodeJS, Express, Sequelize, PostgreSQL, Bcrypt, JWT", Img: "proyects", Animacion: 'flip-left', Link: "https://projects-ribes.netlify.app/" },
